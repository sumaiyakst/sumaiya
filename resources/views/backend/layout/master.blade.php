                ...
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{url('/createproduct')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add Product</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="{{url('/allcomputer')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>All Product</p>
                                    </a> </li>
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link"> <i class="nav-icon bi bi-box-seam-fill"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item"> <a href="{{url('/addphone')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>Add Product</p>
                                    </a> </li>
                                <li class="nav-item"> <a href="{{url('/allphone')}}" class="nav-link"> <i class="nav-icon bi bi-circle"></i>
                                        <p>All Product</p>
                                    </a> </li>
